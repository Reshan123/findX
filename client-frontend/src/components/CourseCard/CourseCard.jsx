...
export default function CourseCard({ course, withDescription }) {
                ...
                <Card sx={{}}>
                    <CardActionArea sx={{ display: 'grid', gridTemplateRows: ' 1fr' }} onClick={() => { goToMoreDetailsPage() }}>
                        <CardMedia
                            ...
                            alt="green iguana"
                        />
                        <CardContent onClick={() => { goToMoreDetailsPage() }} sx={{ display: 'grid', gridTemplateRows: '1.2fr 4fr .5fr' }}>
                ...
                <Card sx={{}}>
                    <CardActionArea sx={{ display: 'grid', gridTemplateRows: ' 1fr' }} onClick={() => { goToMoreDetailsPage() }}>
                        <CardMedia
                            ...
                            alt="green iguana"
                        />
                        <CardContent onClick={() => { goToMoreDetailsPage() }} sx={{ display: 'grid', gridTemplateRows: '1.2fr .5fr' }}>
                            <Typography variant="h5" sx={{ fontWeight: '600' }}>
                                {course.title || "Course Title"}
                            </Typography>
                            {/* <Typography variant="body2" color="text.secondary">
